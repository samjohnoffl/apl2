      ...
      <div className="relative z-10 flex flex-col items-center">
        <div className="relative mb-6">
          <div className="w-24 h-24 rounded-full border-2 border-cyan-500/50 p-1 bg-black/50">
            <div className="w-full h-full rounded-full bg-gradient-to-tr from-cyan-900 to-purple-900 flex items-center justify-center">
        ...
        <div className="grid grid-cols-2 gap-4 w-full">
          <StatBox icon={<Zap className="w-3 h-3" />} label="HYPE" value="840" color="text-yellow-400" />
          ...
          <StatBox icon={<Shield className="w-3 h-3" />} label="AURA" value="LEGEND" color="text-purple-400" />
        </div>

        <div className="mt-8 w-full">
          <div className="flex justify-between text-[10px] font-mono mb-2">
            <span className="text-gray-500 uppercase">Season XP</span>
